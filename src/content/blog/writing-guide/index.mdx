...
When someone else has said it perfectly in a tweet, embed it rather than paraphrasing. A Twitter card preserves the original voice, the author's identity, and the date — context that a blockquote loses.

<TwitterCard id="20" />

Use social embeds sparingly. They break the visual rhythm of your prose and pull the reader's attention toward someone else's platform. One well-chosen embed per post is usually enough. If you are quoting the substance of a tweet rather than the tweet itself, a blockquote with attribution is cleaner.
